...
class test_Place(test_basemodel):
    ...
    def test_city_id(self):
        """ this will test the place city_id """
        new = self.value()
        self.assertEqual(type(new.city_id), str)

    def test_user_id(self):
        """ this will test the place user_id """
        new = self.value()
        self.assertEqual(type(new.user_id), str)

    def test_name(self):
        """ this will test the place name """
        new = self.value()
        self.assertEqual(type(new.name), str)

    def test_description(self):
        """ this will test the place description"""
        new = self.value()
        self.assertEqual(type(new.description), str)

    def test_number_rooms(self):
        """ this will test the place number_rooms """
        new = self.value()
        self.assertEqual(type(new.number_rooms), int)

    def test_number_bathrooms(self):
        """ this will test the place number_bathrooms  """
        new = self.value()
        self.assertEqual(type(new.number_bathrooms), int)

    def test_max_guest(self):
        """ this will test the place max_guest """
        new = self.value()
        self.assertEqual(type(new.max_guest), int)

    def test_price_by_night(self):
        """ this will test the place price_by_night  """
        new = self.value()
        self.assertEqual(type(new.price_by_night), int)

    def test_latitude(self):
        """ this will test the place latitude  """
        new = self.value()
        self.assertEqual(type(new.latitude), float)

    def test_longitude(self):
        """ this will test the place longitude  """
        new = self.value()
        self.assertEqual(type(new.latitude), float)

    def test_amenity_ids(self):
        """ this will test the place amenity_ids  """
        new = self.value()
